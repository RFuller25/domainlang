...
| [expressions.md](expressions.md) | The expression layer: operators, lambdas, conditionals, `consider`, `:=`, stage bindings. The 187 builtin functions are on six pages linked from it |
...
pages can drift from what the language does. 262 runnable examples at present,
