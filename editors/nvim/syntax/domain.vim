...
syn match domainBuiltin /\<\%(occurrences\|cellpoints\|difference\|emptygraph\|fromdigits\|neighbors4\|neighbors8\|startswith\|trimprefix\|trimsuffix\|chebyshev\|emptylist\|enumerate\|factorial\|flipedges\|intersect\|manhattan\|neighbors\|transpose\|contains\|divisors\|emptymap\|emptyset\|endswith\|frombase\|inbounds\|padright\|popcount\|solve2x2\|subgraph\|textjoin\|weightof\|weightor\|addedge\|addnode\|around4\|around8\|bandall\|bxorall\|deledge\|edgesof\|entries\|flatten\|frombin\|fromhex\|hasedge\|indexof\|isalpha\|isdigit\|islower\|isprime\|isupper\|padleft\|product\|repeats\|replace\|reverse\|testbit\|tofloat\|windows\|borall\|charat\|choose\|concat\|degree\|digits\|divmod\|haskey\|insert\|length\|maxcol\|maxrow\|mincol\|minrow\|modinv\|modpow\|pscale\|record\|repeat\|sparse\|tobase\|tolist\|totext\|unique\|values\|weight\|atan2\|cells\|chars\|chunk\|clamp\|dirs4\|dirs8\|edges\|first\|floor\|getor\|graph\|hypot\|isqrt\|log10\|lower\|nodes\|point\|range\|round\|setat\|slice\|split\|tobin\|tohex\|toint\|tomap\|toset\|trunc\|tuple\|union\|upper\|words\|band\|bnot\|bxor\|ceil\|cols\|drop\|fill\|item\|keys\|last\|list\|log2\|padd\|pcol\|prow\|psub\|root\|rotl\|rotr\|rows\|sign\|size\|sort\|sqrt\|take\|trim\|with\|abs\|and\|bor\|chr\|col\|cos\|crt\|del\|exp\|gcd\|get\|has\|lcm\|log\|max\|min\|mod\|not\|ord\|pow\|put\|row\|set\|shl\|shr\|sin\|sum\|tan\|xor\|zip\|at\|or\)\ze\s*(/
